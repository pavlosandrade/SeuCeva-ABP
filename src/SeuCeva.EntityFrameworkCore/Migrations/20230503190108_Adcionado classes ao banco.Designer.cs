...
{
    [DbContext(typeof(SeuCevaDbContext))]
    [Migration("20230503190108_Adcionado classes ao banco")]
    partial class Adcionadoclassesaobanco
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeuCeva.Categorias.Categoria", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeuCeva.Empresas.Empresa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeuCeva.Produtos.Produto", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeuCeva.ProdutosEmpresas.ProdutosEmpresa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SeuCeva.Produtos.Produto", b =>
                {
                    b.HasOne("SeuCeva.Categorias.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("SeuCeva.ProdutosEmpresas.ProdutosEmpresa", b =>
                {
                    b.HasOne("SeuCeva.Empresas.Empresa", "Empresa")
                        .WithMany("ListaProdutos")
                        .HasForeignKey("EmpresaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SeuCeva.Produtos.Produto", "Produto")
                        .WithMany()
